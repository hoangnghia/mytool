    ...
    */
    ...
    zaa.directive("zaaText", function(){
        return {
            ...
            template: function() {
                return '<div class="form-group form-side-by-side" ng-class="{\'input--hide-label\': i18n}"><div class="form-side label-class form-side-label"><label for="{{id}}">{{label}}</label></div><div class="form-side"><input id="{{id}}" insert-paste-listener ng-model="model" type="text" class="form-control" placeholder="{{placeholder}}" /></div></div>';
            }
        }
    });
    ...
    zaa.directive("toolFileManager", function(Upload, ServiceFoldersData, ServiceFilesData, LuyaLoading, AdminToastService, ServiceFoldersDirecotryId) {
        return {
            restrict : 'E',
            transclude : false,
            scope : {
            ...
            controller : function($scope, $http, $filter, $timeout) {
                ...
                $scope.uploadUsingUpload = function(file) {
                    file.upload = Upload.upload({
                        url: 'admin/api-admin-tool/files-upload',
                        file: file
                    });
